  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (!response.ok || result.error) {
        ...
        console.log('Diagnostics signup successful:', result);
        router.push('/diagnostics/login?new=true');
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Join as Diagnostics Center</h1>
          <p className="text-gray-600 mt-2">Create your diagnostic lab account</p>
        </div>
