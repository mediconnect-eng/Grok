// HealthHub Brand Icon Components
...
export const StethoscopeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
...
export const CapsuleIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m10.8 20.4-6.3-6.3a4.95 4.95 0 0 1 0-7l6.3-6.3a4.95 4.95 0 0 1 7 0l6.3 6.3a4.95 4.95 0 0 1 0 7l-6.3 6.3a4.95 4.95 0 0 1-7 0Z" />
...
export const VideoCallIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m16 10 5.111-3.556A1 1 0 0 1 23 7.333V16.667a1 1 0 0 1-1.889.889L16 14" />
